...
In the early 1950s, physicists noticed something strange. Two subatomic particles, known as the tau and the theta, looked identical in every measurable way—same mass, same charge, same lifetime. They should have been the same particle. But they weren’t. The tau decayed into three pions; the theta decayed into two. Their only difference lay in parity, their mirror identity, as if Nature decides mirror images should differ.  

The resolution came in 1956 with the bold, yet revolutionary suggestion by Tsung-Dao Lee and Chen-Ning Yang. The young Chinese American scientists proposed that parity, the symmetry between a physical system and its mirror image, might not be conserved in weak interactions. 
...
Parity was gone, but physicists clung to hope. Maybe if you combined a mirror with antimatter—charge conjugation plus parity, CP—the universe would be restored. A mirrored world of antiparticles should behave like ours. That was the creed of the 1960s.
