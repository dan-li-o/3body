...
<div class="wgt wgt--coin" data-widget="coin-flip" id="wid-coin-sim">
  ...
  <div class="wgt__panel wgt__output" aria-live="polite">
    ...
    <div class="wgt__row">
      ...
      <strong>H/T ratio</strong>    <span data-role="ratio" class="wgt__out">—</span>
      </div>
    <!--<div class="wgt__row"></div>  
    <div class="wgt__row"></div>
    
    <div class="wgt__row"><strong>Heads %</strong><span data-role="p" class="wgt__out">—</span></div>-->
    <div class="wgt__hint">• Click the coin to flip. • H/T is plotted vs. trials. • Uses high-quality randomness when available.</div>
  </div>
</div>
...
```
Coin Flip Device — click to flip; chart shows H/T over trials.
:::
